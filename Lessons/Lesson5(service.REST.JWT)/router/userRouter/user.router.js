...
const {userMiddleware} = require('../../middleware');//реквайрим мідлвари в нашому файлі роутера відповідно в апп цього робити вже не треба
...
router.put('/use_id', user.updateUser);
